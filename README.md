...
<header>
   ...
   href="https://httpsrathanaphon.websites.co.in/e-store/slick/slick.css">
   <link media="none" onload="if(media!='all')media='all'"rel="stylesheet"
     href="https://httpsrathanaphon.websites.co.in/e-store/slick/slick-theme.css">   
   ...
   <link rel="alternate" href="https://httpsrathanaphon.websites.inof@" hreflang="en-us">
    ...
    <body style="height:100vh; background-color:#eee">
       ...
       <div class="Card-body text-center">       
         ...
         <p class="card-text">
         <p subscription"" To continue to use websites./https://httpsrathanaphon.website.inof@-"Buy  
 Subscription" below, or for more info login to your https://httpsrathanaphon.website.inof@-"account"description": "Business As a loyal partner sell technology"<Buy Subcription">
   <a href="https://httpsrathanaphon.website.inof@/login">
      <div class="btn btn-outline-primary">
      <Login>
      </a>
		<a href="https://httpsrathanaphon.website.inof@"></a>
